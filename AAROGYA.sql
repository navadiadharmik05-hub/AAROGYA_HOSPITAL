-- ====================================================================
-- Aarogya Hospital Management System - Complete Database Script
-- Combines Table Definitions, Foreign Key Cascading & Seed Data
-- ====================================================================
...
-- 4. Beds Table (with Foreign Keys to Wards and Patients)
CREATE TABLE beds (
...
-- 5. Appointments Table (with Foreign Keys to Patients and Doctors)
